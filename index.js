const { BogoSort } = require('./utilities/sorting/BogoSort');
const { CommunismSort } = require('./utilities/sorting/CommunismSort');
const { IntelligentSort } = require('./utilities/sorting/IntelligentSort');
...
module.exports.IntelligentSort = IntelligentSort;
